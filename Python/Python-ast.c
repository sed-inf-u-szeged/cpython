...
_Py_IDENTIFIER(endline);
_Py_IDENTIFIER(endcol);
...
stmt_ty
Raise(expr_ty exc, expr_ty cause, int lineno, int col_offset, int endline, int
...
Try(asdl_seq * body, asdl_seq * handlers, asdl_seq * orelse, asdl_seq *
    finalbody, int lineno, int col_offset, int endline, int endcol, PyArena
    *arena)
{
    stmt_ty p;
    p = (stmt_ty)PyArena_Malloc(arena, sizeof(*p));
...
stmt_ty
Nonlocal(asdl_seq * names, int lineno, int col_offset, int endline, int endcol,
         PyArena *arena)
{
    stmt_ty p;
    p = (stmt_ty)PyArena_Malloc(arena, sizeof(*p));
...
expr_ty
Await(expr_ty value, int lineno, int col_offset, int endline, int endcol,
      PyArena *arena)
{
    expr_ty p;
    if (!value) {
...
expr_ty
YieldFrom(expr_ty value, int lineno, int col_offset, int endline, int endcol,
          PyArena *arena)
{
    expr_ty p;
    if (!value) {
...
expr_ty
JoinedStr(asdl_seq * values, int lineno, int col_offset, int endline, int
          endcol, PyArena *arena)
{
    expr_ty p;
    p = (expr_ty)PyArena_Malloc(arena, sizeof(*p));
...
expr_ty
Bytes(bytes s, int lineno, int col_offset, int endline, int endcol, PyArena
      *arena)
{
    expr_ty p;
    if (!s) {
...
expr_ty
NameConstant(singleton value, int lineno, int col_offset, int endline, int
             endcol, PyArena *arena)
{
    expr_ty p;
    if (!value) {
...
expr_ty
Ellipsis(int lineno, int col_offset, int endline, int endcol, PyArena *arena)
{
    expr_ty p;
    p = (expr_ty)PyArena_Malloc(arena, sizeof(*p));
    if (!p)
...
expr_ty
Constant(constant value, int lineno, int col_offset, int endline, int endcol,
         PyArena *arena)
{
    expr_ty p;
    if (!value) {
...
ast2obj_stmt(void* _o)
{
    ...
    if (!value) goto failed;
    if (_PyObject_SetAttrId(result, &PyId_endline, value) < 0)
        goto failed;
    Py_DECREF(value);
    value = ast2obj_int(o->endcol);
    if (!value) goto failed;
    if (_PyObject_SetAttrId(result, &PyId_endcol, value) < 0)
        goto failed;
    Py_DECREF(value);
    return result;
failed:
...
obj2ast_stmt(PyObject* obj, stmt_ty* out, PyArena* arena)
{
    ...
    if (_PyObject_HasAttrId(obj, &PyId_endline)) {
        int res;
        tmp = _PyObject_GetAttrId(obj, &PyId_endline);
        if (tmp == NULL) goto failed;
    ...
    if (_PyObject_HasAttrId(obj, &PyId_endcol)) {
        int res;
        tmp = _PyObject_GetAttrId(obj, &PyId_endcol);
        if (tmp == NULL) goto failed;
    ...
    if (isinstance) {
        ...
        *out = AsyncFunctionDef(name, args, body, decorator_list, returns,
                                lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Return(value, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Delete(targets, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Assign(targets, value, lineno, col_offset, endline, endcol,
                      arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = AugAssign(target, op, value, lineno, col_offset, endline,
                         endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = For(target, iter, body, orelse, lineno, col_offset, endline,
                   endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = While(test, body, orelse, lineno, col_offset, endline, endcol,
                     arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = If(test, body, orelse, lineno, col_offset, endline, endcol,
                  arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = With(items, body, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = AsyncWith(items, body, lineno, col_offset, endline, endcol,
                         arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Raise(exc, cause, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Assert(test, msg, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Import(names, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = ImportFrom(module, names, level, lineno, col_offset, endline,
                          endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Global(names, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Nonlocal(names, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
...
obj2ast_expr(PyObject* obj, expr_ty* out, PyArena* arena)
{
    ...
    if (isinstance) {
        ...
        *out = BoolOp(op, values, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = BinOp(left, op, right, lineno, col_offset, endline, endcol,
                     arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = UnaryOp(op, operand, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Lambda(args, body, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = IfExp(test, body, orelse, lineno, col_offset, endline, endcol,
                     arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Dict(keys, values, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = ListComp(elt, generators, lineno, col_offset, endline, endcol,
                        arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = SetComp(elt, generators, lineno, col_offset, endline, endcol,
                       arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = DictComp(key, value, generators, lineno, col_offset, endline,
                        endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = GeneratorExp(elt, generators, lineno, col_offset, endline,
                            endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Await(value, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = YieldFrom(value, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Compare(left, ops, comparators, lineno, col_offset, endline,
                       endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Call(func, args, keywords, lineno, col_offset, endline, endcol,
                    arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = JoinedStr(values, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Bytes(s, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = NameConstant(value, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Ellipsis(lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Constant(value, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Attribute(value, attr, ctx, lineno, col_offset, endline, endcol,
                         arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Subscript(value, slice, ctx, lineno, col_offset, endline,
                         endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Starred(value, ctx, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Name(id, ctx, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = List(elts, ctx, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
    ...
    if (isinstance) {
        ...
        *out = Tuple(elts, ctx, lineno, col_offset, endline, endcol, arena);
        if (*out == NULL) goto failed;
        return 0;
    }
