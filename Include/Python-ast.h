...
stmt_ty _Py_FunctionDef(identifier name, arguments_ty args, asdl_seq * body,
                        ...
                        int col_offset, int endline, int endcol, PyArena
                        *arena);
...
stmt_ty _Py_AsyncFunctionDef(identifier name, arguments_ty args, asdl_seq *
                             ...
                             int lineno, int col_offset, int endline, int
...
stmt_ty _Py_Return(expr_ty value, int lineno, int col_offset, int endline, int
                   endcol, PyArena *arena);
#define Delete(a0, a1, a2, a3, a4, a5) _Py_Delete(a0, a1, a2, a3, a4, a5)
stmt_ty _Py_Delete(asdl_seq * targets, int lineno, int col_offset, int endline,
                   int endcol, PyArena *arena);
...
stmt_ty _Py_AugAssign(expr_ty target, operator_ty op, expr_ty value, int
                      lineno, int col_offset, int endline, int endcol, PyArena
                      *arena);
...
stmt_ty _Py_AnnAssign(expr_ty target, expr_ty annotation, expr_ty value, int
                      simple, int lineno, int col_offset, int endline, int
                      endcol, PyArena *arena);
#define For(a0, a1, a2, a3, a4, a5, a6, a7, a8) _Py_For(a0, a1, a2, a3, a4, a5, a6, a7, a8)
stmt_ty _Py_For(expr_ty target, expr_ty iter, asdl_seq * body, asdl_seq *
                orelse, int lineno, int col_offset, int endline, int endcol,
                PyArena *arena);
...
stmt_ty _Py_AsyncFor(expr_ty target, expr_ty iter, asdl_seq * body, asdl_seq *
                     orelse, int lineno, int col_offset, int endline, int
                     endcol, PyArena *arena);
...
stmt_ty _Py_Try(asdl_seq * body, asdl_seq * handlers, asdl_seq * orelse,
                asdl_seq * finalbody, int lineno, int col_offset, int endline,
                int endcol, PyArena *arena);
...
stmt_ty _Py_Import(asdl_seq * names, int lineno, int col_offset, int endline,
                   int endcol, PyArena *arena);
...
stmt_ty _Py_Global(asdl_seq * names, int lineno, int col_offset, int endline,
                   int endcol, PyArena *arena);
#define Nonlocal(a0, a1, a2, a3, a4, a5) _Py_Nonlocal(a0, a1, a2, a3, a4, a5)
stmt_ty _Py_Nonlocal(asdl_seq * names, int lineno, int col_offset, int endline,
                     int endcol, PyArena *arena);
#define Expr(a0, a1, a2, a3, a4, a5) _Py_Expr(a0, a1, a2, a3, a4, a5)
stmt_ty _Py_Expr(expr_ty value, int lineno, int col_offset, int endline, int
                 endcol, PyArena *arena);
#define Pass(a0, a1, a2, a3, a4) _Py_Pass(a0, a1, a2, a3, a4)
stmt_ty _Py_Pass(int lineno, int col_offset, int endline, int endcol, PyArena
                 *arena);
#define Break(a0, a1, a2, a3, a4) _Py_Break(a0, a1, a2, a3, a4)
stmt_ty _Py_Break(int lineno, int col_offset, int endline, int endcol, PyArena
                  *arena);
#define Continue(a0, a1, a2, a3, a4) _Py_Continue(a0, a1, a2, a3, a4)
stmt_ty _Py_Continue(int lineno, int col_offset, int endline, int endcol,
                     PyArena *arena);
...
expr_ty _Py_Set(asdl_seq * elts, int lineno, int col_offset, int endline, int
                endcol, PyArena *arena);
...
expr_ty _Py_Await(expr_ty value, int lineno, int col_offset, int endline, int
                  endcol, PyArena *arena);
#define Yield(a0, a1, a2, a3, a4, a5) _Py_Yield(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Yield(expr_ty value, int lineno, int col_offset, int endline, int
                  endcol, PyArena *arena);
#define YieldFrom(a0, a1, a2, a3, a4, a5) _Py_YieldFrom(a0, a1, a2, a3, a4, a5)
expr_ty _Py_YieldFrom(expr_ty value, int lineno, int col_offset, int endline,
                      int endcol, PyArena *arena);
#define Compare(a0, a1, a2, a3, a4, a5, a6, a7) _Py_Compare(a0, a1, a2, a3, a4, a5, a6, a7)
expr_ty _Py_Compare(expr_ty left, asdl_int_seq * ops, asdl_seq * comparators,
                    int lineno, int col_offset, int endline, int endcol,
                    PyArena *arena);
#define Call(a0, a1, a2, a3, a4, a5, a6, a7) _Py_Call(a0, a1, a2, a3, a4, a5, a6, a7)
expr_ty _Py_Call(expr_ty func, asdl_seq * args, asdl_seq * keywords, int
                 lineno, int col_offset, int endline, int endcol, PyArena
                 *arena);
#define Num(a0, a1, a2, a3, a4, a5) _Py_Num(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Num(object n, int lineno, int col_offset, int endline, int endcol,
                PyArena *arena);
#define Str(a0, a1, a2, a3, a4, a5) _Py_Str(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Str(string s, int lineno, int col_offset, int endline, int endcol,
                PyArena *arena);
...
expr_ty _Py_JoinedStr(asdl_seq * values, int lineno, int col_offset, int
                      endline, int endcol, PyArena *arena);
#define Bytes(a0, a1, a2, a3, a4, a5) _Py_Bytes(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Bytes(bytes s, int lineno, int col_offset, int endline, int endcol,
                  PyArena *arena);
#define NameConstant(a0, a1, a2, a3, a4, a5) _Py_NameConstant(a0, a1, a2, a3, a4, a5)
expr_ty _Py_NameConstant(singleton value, int lineno, int col_offset, int
                         endline, int endcol, PyArena *arena);
#define Ellipsis(a0, a1, a2, a3, a4) _Py_Ellipsis(a0, a1, a2, a3, a4)
expr_ty _Py_Ellipsis(int lineno, int col_offset, int endline, int endcol,
                     PyArena *arena);
#define Constant(a0, a1, a2, a3, a4, a5) _Py_Constant(a0, a1, a2, a3, a4, a5)
expr_ty _Py_Constant(constant value, int lineno, int col_offset, int endline,
                     int endcol, PyArena *arena);
